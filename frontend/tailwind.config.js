  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        dilatationColor: "#176B87",
        prescriptionColor: "#83B4FF",
        contactLensesColor: "#5C88C4",
        glassesColor: "#CD5888",
        LensesColor: "#5C88C4",
        investigationColor: "#597445",
        extInvestColor: "#658147",
        surgeryColor: "#973131",
        procedureColor: "#686D76",

        sickColor: "#DC5F00",

        referColor: "#AF8260",
        dischargeColor: "#C40C0C",
        darkIcon: "#402E7A",
        skyBlue: "#009efb",
        teal: "#20B2AA",
        dodgerBlue: "#1E90FF",
      ...
      backgroundColor: {
        "black-500-rgba": "rgba(0, 0, 0, 1)",
      },
      // backgroundImage: {
      //   'gradient-mesh': "url('../src/assets/images/icon/gradient-mesh.svg')",
      // },
      gridTemplateColumns: {
